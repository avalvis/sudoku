...
export function ArchivePage() {
  ...
  return <main id="main-content" tabIndex={-1} className="stats-page archive-page">
    ...
    <footer className="stats-footnote"><p>Every replay begins a new attempt. Only one Classic puzzle can be in progress at a time; Daily boards are saved separately. Completions include practice games; best times use normal games only. Your full attempt history is in <a href="#stats">Stats</a>.</p><span>Nine puzzles, available offline. More editions will follow.</span></footer>
